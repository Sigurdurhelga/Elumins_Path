...
namespace CameraSmooth2D
{
    public class CameraManager : MonoBehaviour
    {
        ...
        void FixedUpdate()
        {
            ...
            XDifference = Mathf.Abs(focusObject.transform.position.x - transform.position.x);
            YDifference = Mathf.Abs(focusObject.transform.position.y - transform.position.y);
